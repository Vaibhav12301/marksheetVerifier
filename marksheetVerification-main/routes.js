...
function routes(app,dbe,lms,accounts){
                        ...
                        <div class="grid grid-rows-auto gap-0">
                            <div id="header" class="flex justify-around items-center px-10 gap-10">
                                ...
                                <div class="grid grid-rows-auto gap-1 py-2 text-center rounded ">
                                    <span class="text-2xl font-semibold uppercase">Datta Meghe College of Engineering</span>
                                    <span class="text-base">
                                        Motto: To create values-based technocrats to fit in the world of work and research.<br>
                                ...
                                <img class="w-24 rounded" src="https://www.dmce.ac.in/assets/img/dmce.png"
                                    alt="logo">
                            </div>
                            <div id="studentProfile" class="flex justify-between items-center prose-table:my-0 p-3 gap-4">
                                <table class="table-fixed border-collapse border border-slate-400 uppercase font-semibold">
                                    <tbody>
                                    <tr>
                                        <td class="border border-slate-400 text-sm">SESSION: <span>2024</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-slate-400 text-sm">SEMISTER: <span>8<sup>th</sup></span></td>
                            ...
                            <div id="academicRecord" class="grid grid-rows-auto  prose-table:my-0 p-3 gap-1">
                                <table class="table-fixed border-collapse border border-slate-400 text-center uppercase font-semibold">
                                    ...
                                    <tr>
                                    <td class="border border-slate-400 text-sm">ITC801</td>
                                    <td class="border border-slate-400 text-sm text-left">BLockchain & DLT</td>
                                    <td class="border border-slate-400 text-sm">100 </td>
                                    <td class="border border-slate-400 text-sm">${Mark1} </td>
                                    </tr>
                                    <tr>
                                    <td class="border border-slate-400 text-sm">ITDO8011</td>
                                    <td class="border border-slate-400 text-sm text-left">Big Data Analytics</td>
                                    <td class="border border-slate-400 text-sm">100 </td>
                                    <td class="border border-slate-400 text-sm">${Mark2} </td>
                                    </tr>
                                    <tr>
                                    <td class="border border-slate-400 text-sm">ITLO8029</td>
                                    <td class="border border-slate-400 text-sm text-left">Environment Management</td>
                                    <td class="border border-slate-400 text-sm">100 </td>
                                    <td class="border border-slate-400 text-sm"> ${Mark4}</td>
                                    </tr>
                                    <tr>
                                    <td class="border border-slate-400 text-sm">ITDO8021</td>
                                    <td class="border border-slate-400 text-sm text-left">User Interface Design</td>
                                    <td class="border border-slate-400 text-sm">100 </td>
                                    <td class="border border-slate-400 text-sm"> ${Mark3}</td>
                                    </tr>
                                    <tr>
                                    <td class="border border-slate-400 text-sm">ITLO8028</td>
                                    <td class="border border-slate-400 text-sm text-left">Project Management</td>
                                    <td class="border border-slate-400 text-sm">100 </td>
                                ...
                                <table class="table-auto border-collapse border border-slate-400 font-semibold">
                                    ...
                                    <tr>
                                        <th class="border border-slate-400 text-sm">
                                            ...
                                            <span class="uppercase">June,2024</span>
    ...
    function messageContent(name){
        let message = `Hello ${name},<br>
                This is your marksheet of semester-8 Information Technology, Mumbai University.<br>
        ...
        db.findOne({Rollno},async (err,student)=>{
            ...
            if(!student){
                ...
                var transporter = nodemailer.createTransport({
                    service: 'outlook',
                    auth: {
                      user: 'vaibhavgaikwad12301@outlook.com',
                      pass: 'Vaibhav@out12301'
                    }
                  });
                ...
                var mailOptions = {
                    from: 'vaibhavgaikwad12301@outlook.com',
                    to: student.Email,
                    subject: 'Sem 8 Marksheet',
                    attachments: [{
    ...
    app.post('/verifyMarksheet',async(req,res)=>{
        ...
        if(resultValid == 'valid'){
            ...
            res.status(400).send('The certificate is valid')
        }
